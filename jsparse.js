...
function Tokenizer(s, f, l) {
    ...
    //Sian: tokens stores all looked-ahead tokens (at most 4)
    this.tokens = [];
    this.tokenIndex = 0;
    this.lookahead = 0;
...
Tokenizer.prototype = {
    ...
    get: function () {
        ...
        for (;;) {
            ...
            //Sian: var match = (this.scanNewlines ? /^[ \t]+/ : /^\s+/)(input);
        ...
        if ((match = fpRegExp.exec(input))) {
            ...
            if (assignOps[op] && input[op.length] == '=') {
                ...
                //Sian: interesting: turn plus|minus into unary_plus|unary_minus
                //see jsdefs.js:tokens definition
                if (this.scanOperand &&
